...
import chamber_agent_pb2 as chamber__agent__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in chamber_agent_pb2_grpc.py depends on'
...
def add_AgentRuntimeServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'chamber.agent.v1.AgentRuntime', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('chamber.agent.v1.AgentRuntime', rpc_method_handlers)
